...
/** Utility functions used by the Tesla Qt UI.
 */
namespace GUIUtil
{
...
// Render Tesla addresses in monospace font
...
// Parse "tesla:" URI into recipient object, return true on successful parsing
