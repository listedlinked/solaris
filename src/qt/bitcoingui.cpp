                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Tesla Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tesla address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tesla: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tesla Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tesla Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tesla"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tesla addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tesla addresses"));
    ...
    openAction->setStatusTip(tr("Open a Tesla: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tesla Core help message to get a list with possible Tesla command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Tesla Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tesla network", "", count));
}
...
{
    QString strTitle = tr("Tesla Core"); // default title
