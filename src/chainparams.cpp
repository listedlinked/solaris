...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 60020;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Tesla starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 210000;
        nMaxReorganizationDepth = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Tesla: 1 minute
        nTargetSpacing = 1 * 60;  // Tesla: 1 minute
        nMaturity = 10;
		...
		const char* pszTimestamp = "Tesla 30-09-2017";
...
public:
    CTestNetParams()
    {
        ...
        nDefaultPort = 51474;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Tesla: 1 day
        nTargetSpacing = 1 * 60;  // Tesla: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 82); // Testnet tesla addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet tesla script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet tesla BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet tesla BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet tesla BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Tesla: 1 day
        nTargetSpacing = 1 * 60;        // Tesla: 1 minutes
