...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Tesla Core tesla-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tesla-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tesla transaction") + "\n" +
                               "  tesla-tx [options] -create [commands]   " + _("Create hex-encoded tesla transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tesla transaction
