...
In order to support loading of multiple wallets in tesla-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tesla.cpp.
...
Changes to tesla.cpp
----------------------
tesla.cpp is the entry point into tesla-qt, and as such, will require some minor modifications to provide hooks for
