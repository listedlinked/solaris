Tesla Core version 3.0.4 is now available from:
...
Tesla Core v3.0.4 is a mandatory update for all users. This release contains various updates/fixes pertaining to the zXLR protocol, supply tracking, block transmission and relaying, as well as usability and quality-of-life updates to the GUI.
...
- #314 `f1c830a` Fix issue causing crash when teslad --help was invoked (Jon Spock)
- #326 `8b6a13e` Combine 2 LogPrintf statement to reduce debug.log clutter (Jon Spock)
- #328 `a6c18c8` [Main] Tesla not responding on user quitting app (Aaron Langford)
