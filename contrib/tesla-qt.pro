...
RESOURCES += src/qt/tesla.qrc src/qt/tesla_locale.qrc

TRANSLATIONS += src/qt/locale/tesla_bg.ts \
                src/qt/locale/tesla_de.ts \
                src/qt/locale/tesla_en.ts \
                src/qt/locale/tesla_es.ts \
                src/qt/locale/tesla_fi.ts \
                src/qt/locale/tesla_fr.ts \
                src/qt/locale/tesla_it.ts \
                src/qt/locale/tesla_ja.ts \
                src/qt/locale/tesla_pl.ts \
                src/qt/locale/tesla_pt.ts \
                src/qt/locale/tesla_ru.ts \
                src/qt/locale/tesla_sk.ts \
                src/qt/locale/tesla_sv.ts \
                src/qt/locale/tesla_vi.ts \
                src/qt/locale/tesla_zh_CN.ts \
                src/qt/locale/tesla_zh_TW.ts
