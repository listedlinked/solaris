...
This means one can have an always-on teslad instance running, and another local teslad/tesla-qt instance which connects to this node and receives blocks from it.
