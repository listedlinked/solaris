Contributing to Tesla Core
============================

The Tesla Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Tesla Core project, and is not to be
confused with overall Tesla Network Protocol consensus changes.

Whether a pull request is merged into Tesla Core rests with the project merge
...
Patches that change Tesla consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tesla consensus, it must have been
...
The project leader is the release manager for each Tesla Core release.
